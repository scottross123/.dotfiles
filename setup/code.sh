...
CODE_DIR=$HOME/.config/VSCodium/User

ln -s $HOME/.dotfiles/config/code/settings.json $CODE_DIR/settings.json
ln -s $HOME/.dotfiles/config/code/keybindings.json $CODE_DIR/keybindings.json
